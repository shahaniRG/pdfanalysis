function gR = radialDistribution3D2(switchVal,gR,coords,Lx,Ly,Lz,NumOfBins)
...
%       
        ...
        switch switchVal
            ...
            case results
                ...
                nPart = size(coords,2);
                rho = nPart/(Lx*Ly*Lz); % Density of the particles
                ...
                for bin = 1:nBins
                    ...
                    nIdeal = ereaBin*rho;
                    % Normalize the bin
                    gR.histo(bin) = gR.histo(bin) / nIdeal; %1/16/18 took our by Insung 
                end
                
                % The radial distribution function should be normalized.
                 gR.histo = 2*gR.histo/(nPart-1); %1/16/18 %took out by Insung 
